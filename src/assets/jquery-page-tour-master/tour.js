$.fn.PageTour = function (opts) {
  var
    _o = $.extend({
      ...
      exitClass : 'btn btn-danger dnone',
      defaultIndex : 9999,
      styleOverwrites : {}
    }, opts),
    programmatic = false,
  ...
  function __init() {
    ...
    elements.tour
      .css({ display : 'none', top : 0, left : 0, 'z-index' : 9999 })
      .append(
        elements.overlay,
        elements.title,
        elements.description,
  ...
  function shadowElement() {
    elements.shadow.css({
      height : dims[ 'elHeight' ] + (_o.generalPadding * 2),
      width : dims[ 'elWidth' ] + (_o.generalPadding * 4),
      left : dims[ 'elLeft' ] - (_o.generalPadding * 2),
      top : dims[ 'elTop' ] - (_o.generalPadding * 1),      
      'box-shadow' : '0px 0px 5px 5px rgba(0,0,0,0.8) inset, 0px 0px 5px 3000px rgba(0,0,0,0.8)'
    });
  }
  ...
  function setupStyle() {
    ...
    var styles = {
      ...
      'tour' : {
        ...
        style : 'position: absolute;overflow:hidden;transition:height 0.66s ease-out!important;'
      },
      'title' : {
        selector : '.' + _o.prefix + '_title',
        style : 'top: 0; left: 0; text-shadow: 0 0 10px #aaa; color: white; font-size: 2em; position: absolute; font-weight: bold !important; width: 35rem; text-align:left;'
      },
      'description' : {
      ...
      'controls' : {
        ...
        style : 'top: 0; left: 0; margin: 8px 0; text-align: right; padding: 10px 10px 10px 0; color: white; font-size: 20px; position: absolute; z-index: 10000; transition: all 0.75s; transition-timing-function: ease-in-out;'
      },
      'control_buttons' : {
      ...
      'targets' : {
        ...
        style : 'top: 0; left: 0; border-radius: 50%; border: 1px solid #333; position: absolute; opacity: 0.3;overflow: hidden!important;width:250px;height:250px;'
      },
      'target_large' : {
      ...
      'spotlight' : {
        ...
        style : 'overflow: hidden; transition: all 0.75s; transition-timing-function: ease-in-out; position: absolute; border-radius: 5px;max-width: 180px;margin:3px 0 0 10px;min-width:150px!important;'
      }
    };
