...
export class TeamLevelTwoComponent implements OnInit {
  ...
  uID:string = this.DataService.getUserId();
  driverID:string;
  l2User:string = '';
  l2Uid:string = '';
  depID:string;
  ...
  getKpi(item, i) {
    ...
    // console.log('running getMilestoneAssignUsersL2');
    this.dataservice.getMileStoneAssignUsersl2(deptID,item.uID,"L" + this.lv3.toString());
