...
@Component({
  selector: 'app-portfolio-team-level-three',
...
export class PortfolioTeamLevelThreeComponent implements OnInit {
  ...
  setSubscriptions():void {
    ...
    this.portfolioUserDataSubscription = this.dataservice.userPlusOneData.subscribe((data:string) => {
