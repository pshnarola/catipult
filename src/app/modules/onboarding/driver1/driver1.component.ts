...
@Component({
  ...
  styleUrls: ["./driver1.component.scss"]
})
export class Driver1Component implements OnInit {
  @ViewChild("objective", { static: false }) nameField: ElementRef;

  outcomeStatementDataSubscription:Subscription;
  ...
  ngOnInit() {
    ...
    this.outcomeStatementDataSubscription = this.dataservice.outcomeStatementData.subscribe((data:any) => {
      this.statement = data.s.statement
    });
  ...
  destroySubscriptions():void {
    this.outcomeStatementDataSubscription ? this.outcomeStatementDataSubscription.unsubscribe() : null;
  }
